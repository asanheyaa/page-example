		...
		var l = {
			...
			ready: function () {
				l.clearUrlQuery(),
					...
					p(".wpforms-randomize").each(function () {
						for (var e = p(this), t = e.children(); t.length;) e.append(t.splice(Math.floor(Math.random() * t.length), 1)[0]);
					}),
					...
					(p(".wpforms-input-temp-name").each(function (e, t) {
								...
								return (
									...
									(this.startRequest(r),
										p.post({
											...
											success: function (e) {
												var t = {};
												(n = e.success && e.data) ? (a.resetInternals(), (a.toHide = a.errorsFor(r)), a.showErrors()) : ((t[r.name] = wpforms_settings.val_email_restricted), a.showErrors(t)), a.stopRequest(r, n);
											},
										}),
										n)
								);
						...
						p.validator.addMethod(
							...
							function (e, t, r) {
								...
								return p(a.find("input")[0]).val() === p(a.find("input")[1]).val();
							},
							...
							function (e, t) {
								...
								return (
									...
									(l.compareTimesGreaterThan(a, r)
										? l.compareTimesGreaterThan(e, r) && l.compareTimesGreaterThan(a, e)
										: (l.compareTimesGreaterThan(e, r) && l.compareTimesGreaterThan(e, a)) || (l.compareTimesGreaterThan(r, e) && l.compareTimesGreaterThan(a, e)))
								);
							},
							function (e, t) {
								var t = p(t),
						...
						p.validator.addMethod(
							"smart-phone-field",
							function (e, t) {
								return !e.match(/[^\d()\-+\s]/) && (this.optional(t) || p(t).intlTelInput("isValidNumber"));
							},
						...
						p.validator.addMethod(
							...
							function (e, t) {
								var r = p(t);
								return ("" === r.val().trim() && !r.hasClass("wpforms-field-required")) || WPFormsPasswordField.passwordStrength(e, t) >= Number(r.data("password-strength-level"));
							},
						...
						p(".wpforms-validate").each(function () {
							var e = p(this),
								t = e.data("formid"),
								t =
									void 0 !== s["wpforms_" + t] && s["wpforms_" + t].hasOwnProperty("validate")
											...
											: {
												...
												errorPlacement: function (e, t) {
													l.isLikertScaleField(t)
														? (t.closest("table").hasClass("single-row") ? t.closest(".wpforms-field") : t.closest("tr").find("th")).append(e)
														: l.isWrappedField(t)
												...
												highlight: function (e, t, r) {
													var e = p(e),
														...
														o = e.attr("name");
													("radio" === e.attr("type") || "checkbox" === e.attr("type") ? a.find('input[name="' + o + '"]') : e).addClass(t).removeClass(r), a.addClass("wpforms-has-error");
												},
												unhighlight: function (e, t, r) {
													var e = p(e),
														a = e.closest(".wpforms-field"),
														o = e.attr("name");
													("radio" === e.attr("type") || "checkbox" === e.attr("type") ? a.find('input[name="' + o + '"]') : e).addClass(r).removeClass(t), a.removeClass("wpforms-has-error");
												},
												submitHandler: function (o) {
													function e() {
														...
														if (
															(t.data("token") && 0 === p(".wpforms-token", t).length && p('<input type="hidden" class="wpforms-token" name="wpforms[token]" />').val(t.data("token")).appendTo(t),
																r.prop("disabled", !0),
															...
															return (
																grecaptcha.execute(a).then(null, function (e) {
																	(e = null === e ? "" : "<br>" + e),
																		t.find(".wpforms-recaptcha-container").append('<label id="wpforms-field_recaptcha-error" class="wpforms-error"> ' + wpforms_settings.val_recaptcha_fail_msg + e + "</label>"),
																		r.prop("disabled", !1);
																}),
																!1
															);
														p(".wpforms-input-temp-name").removeAttr("name"), l.formSubmit(t);
													}
													return "function" == typeof wpformsRecaptchaV3Execute ? wpformsRecaptchaV3Execute(e) : e();
												},
												invalidHandler: function (e, t) {
													void 0 !== t.errorList[0] && l.scrollToError(p(t.errorList[0].element));
												},
												onkeyup: function (e, t) {
													p(e).hasClass("wpforms-novalidate-onkeyup") ||
														(9 === t.which && "" === this.elementValue(e)) ||
														-1 !== p.inArray(t.keyCode, [16, 17, 18, 20, 35, 36, 37, 38, 39, 40, 45, 144, 225]) ||
														((e.name in this.submitted || e.name in this.invalid) && this.element(e));
												},
												onfocusout: function (e) {
													var t = !1;
													p(e).hasClass("wpforms-novalidate-onkeyup") && !e.value && (t = !0), (t = this.checkable(e) || (!(e.name in this.submitted) && this.optional(e)) ? t : !0) && this.element(e);
												},
												onclick: function (e) {
													var t = !1,
														r = (e || {}).type,
														a = p(e);
													-1 < ["checkbox", "radio"].indexOf(r) && ((a = a.hasClass("wpforms-likert-scale-option") ? a.closest("tr") : a.closest(".wpforms-field")).find("label.wpforms-error").remove(), (t = !0)),
														t && this.element(e);
												},
											};
							e.validate(t);
				...
				void 0 !== p.fn.flatpickr &&
					p(".wpforms-datepicker-wrap").each(function () {
						var a = p(this),
							...
							r =
								void 0 !== s["wpforms_" + t + "_" + r] && s["wpforms_" + t + "_" + r].hasOwnProperty("datepicker")
									? s["wpforms_" + t + "_" + r].datepicker
									: void 0 !== s["wpforms_" + t] && s["wpforms_" + t].hasOwnProperty("datepicker")
										? s["wpforms_" + t].datepicker
										: "undefined" != typeof wpforms_datepicker
											? wpforms_datepicker
											: { disableMobile: !0 },
							o =
								(!r.hasOwnProperty("locale") && "undefined" != typeof wpforms_settings && wpforms_settings.hasOwnProperty("locale") && (r.locale = wpforms_settings.locale),
									(r.wrap = !0),
				...
				void 0 !== p.fn.timepicker &&
					p(".wpforms-timepicker").each(function () {
						var e = p(this),
							...
							r =
								void 0 !== s["wpforms_" + t + "_" + r] && s["wpforms_" + t + "_" + r].hasOwnProperty("timepicker")
									? s["wpforms_" + t + "_" + r].timepicker
									: void 0 !== s["wpforms_" + t] && s["wpforms_" + t].hasOwnProperty("timepicker")
			...
			loadSmartPhoneField: function () {
				...
				void 0 !== p.fn.intlTelInput &&
					((a = {}),
						...
						wpforms_settings.gdpr && ((e = this.getFirstBrowserLanguage()), (t = -1 < e.indexOf("-") ? e.split("-").pop() : "")),
						(t =
							t &&
						...
						p(".wpforms-smart-phone-field").each(function (e, t) {
							var r = p(t);
							(a.hiddenInput = r.closest(".wpforms-field-phone").data("field-id")),
								(a.utilsScript = wpforms_settings.wpforms_plugin_url + "assets/pro/lib/intl-tel-input/jquery.intl-tel-input-utils.min.js"),
								r.intlTelInput(a),
								r.attr("name", "wpf-temp-" + r.attr("name")),
								r.addClass("wpforms-input-temp-name"),
								r.on("blur input", function () {
									(!r.intlTelInput("isValidNumber") && l.empty(s.WPFormsEditEntry)) || r.siblings('input[type="hidden"]').val(r.intlTelInput("getNumber"));
								});
						}),
			...
			loadPayments: function () {
				p(".wpforms-payment-total").each(function (e, t) {
					...
					void 0 !== p.fn.payment && (p(".wpforms-field-credit-card-cardnumber").payment("formatCardNumber"), p(".wpforms-field-credit-card-cardcvc").payment("formatCardCVC"));
			},
			loadMailcheck: function () {
				wpforms_settings.mailcheck_enabled &&
					void 0 !== p.fn.mailcheck &&
					(0 < wpforms_settings.mailcheck_domains.length && (Mailcheck.defaultDomains = Mailcheck.defaultDomains.concat(wpforms_settings.mailcheck_domains)),
						...
						p(n).on("blur", ".wpforms-field-email input", function () {
							...
							e.mailcheck({
								suggested: function (e, t) {
									t.address.match(/^xn--/) && ((t.full = punycode.toUnicode(decodeURI(t.full))), (r = t.full.split("@")), (t.address = r[0]), (t.domain = r[1])),
						...
						p(n).on("click", ".wpforms-field-email .mailcheck-suggestion", function (e) {
							var t = p(this),
			...
			loadChoicesJS: function () {
				"function" == typeof s.Choices &&
					p(".wpforms-field-select-style-modern .choicesjs-select, .wpforms-field-payment-select .choicesjs-select").each(function (e, t) {
						var r, a;
						p(t).data("choicesjs") ||
							((r = s.wpforms_choicesjs_config || {}),
								...
								(r.callbackOnInit = function () {
									...
									r.removeAttr("hidden").addClass(t.config.classNames.input + "--hidden"),
										...
										r.prop("multiple") && (a.data("placeholder", a.attr("placeholder")), t.getValue(!0).length && a.removeAttr("placeholder")),
										r.on("change", function () {
											var e;
											r.prop("multiple") && (t.getValue(!0).length ? a.removeAttr("placeholder") : a.attr("placeholder", a.data("placeholder"))), (e = r.closest("form").data("validator")) && e.element(r);
										});
								}),
									...
									return {
										option: function (e) {
											...
											return (
												...
												r.hasClass("wpforms-payment-price") && void 0 !== e.customProperties && null !== e.customProperties && (t.dataset.amount = e.customProperties),
												t
											);
										},
									};
			...
			bindUIActions: function () {
				p(n).on("click", ".wpforms-page-button", function (e) {
					...
					p(".wpforms-field-rating-item").hover(
						function () {
							p(this).parent().find(".wpforms-field-rating-item").removeClass("selected hover"), p(this).prevAll().addBack().addClass("hover");
						},
						function () {
							p(this).parent().find(".wpforms-field-rating-item").removeClass("selected hover"), p(this).parent().find("input:checked").parent().prevAll().addBack().addClass("selected");
						}
					),
					...
					p(n).on("keypress", ".wpforms-image-choices-item label", function (e) {
						var t = p(this);
					...
					p(n).on("change", ".wpforms-field-checkbox input, .wpforms-field-radio input, .wpforms-field-payment-multiple input, .wpforms-field-payment-checkbox input, .wpforms-field-gdpr-checkbox input", function (e) {
						var t = p(this);
						if (t.closest(".wpforms-field").hasClass("wpforms-conditional-hide")) return e.preventDefault(), !1;
						switch (t.attr("type")) {
							case "radio":
					...
					p(n).on("change", '.wpforms-field-file-upload input[type=file]:not(".dropzone-input")', function () {
						var e = p(this),
							...
							n = e.prev();
						t.each(function () {
							for (var e = p(this), t = 0, r = e[0].files.length; t < r; t++) a += e[0].files[t].size;
						}),
							r < a
								? ((a = Number((a / 1048576).toFixed(3))),
									...
									n.hasClass("wpforms-error-container")
										? (n.find(".wpforms-error-container-post_max_size").remove(), n.append(o))
										: e.before('<div class="wpforms-error-container">{errorMsg}</span></div>'.replace(/{errorMsg}/, o)),
									i.prop("disabled", !0))
								: (n.find(".wpforms-error-container-post_max_size").remove(), i.prop("disabled", !1));
					}),
					p(n).on("change input", ".wpforms-field-number-slider input[type=range]", function (e) {
					...
					p(n).on("keydown", ".wpforms-form input", function (e) {
						...
						13 !== e.keyCode ||
							...
							(t.hasClass("wpforms-datepicker") && t.flatpickr("close"), e.preventDefault(), (r.hasClass("last") ? r.closest(".wpforms-form").find(".wpforms-submit") : r.find(".wpforms-page-next")).click());
					}),
			...
			scrollToError: function (e) {
				var t;
				0 !== e.length &&
					0 !== (t = 0 === (t = e.find(".wpforms-field.wpforms-has-error")).length ? e.closest(".wpforms-field") : t).length &&
					void 0 !== (e = t.offset()) &&
			...
			navigateToPage: function (t, r, a, o, i) {
				let n = a,
					e = ("next" === r ? (n += 1) : "prev" === r && --n, WPFormsUtils.triggerEvent(t, "wpformsBeforePageChange", [n, o]));
				if (!e.isDefaultPrevented()) {
					i.hide();
					let e = o.find(".wpforms-page-" + n);
					e.show(), l.toggleReCaptchaAndSubmitDisplay(o, r, e);
					a = l.getPageScroll(o);
					a && l.animateScrollTop(o.offset().top - a, 750, null), t.trigger("wpformsPageChange", [n, o]), l.manipulateIndicator(n, o);
				}
			},
			toggleReCaptchaAndSubmitDisplay: function (e, t, r) {
				...
				"next" === t && r.hasClass("last") ? (o.show(), a.show()) : "prev" === t && (o.hide(), a.hide());
			},
			getPageScroll: function (e) {
				return !1 !== s.wpforms_pageScroll && (l.empty(s.wpform_pageScroll) ? 0 !== e.find(".wpforms-page-indicator").data("scroll") && 75 : s.wpform_pageScroll);
			},
			manipulateIndicator: function (e, t) {
				const r = t.find(".wpforms-page-indicator");
				var a;
				r && ("connector" === (a = r.data("indicator")) || "circles" === a ? l.manipulateConnectorAndCirclesIndicator(r, a, e) : "progress" === a && l.manipulateProgressIndicator(r, t, e));
			},
			manipulateConnectorAndCirclesIndicator: function (e, t, r) {
				...
				e.find(".wpforms-page-indicator-page").removeClass("active"),
					...
					"connector" === t && (e.find(".wpforms-page-indicator-page-triangle").removeAttr("style"), e.find(".active .wpforms-page-indicator-page-triangle").css("border-top-color", a));
			},
			manipulateProgressIndicator: function (e, t, r) {
				...
				e.find(".wpforms-page-indicator-page-progress").css("width", n + "%"),
					...
					a.data("page-" + r + "-title") ? (a.css("display", "inline").text(a.data("page-" + r + "-title")), o.css("display", "inline")) : (a.css("display", "none"), o.css("display", "none"));
			},
			...
			amountTotal: function (e, r) {
				...
				a.find(".wpforms-payment-total").each(function (e, t) {
					"hidden" === p(this).attr("type") || "text" === p(this).attr("type") ? (p(this).val(o), "text" === p(this).attr("type") && r && a.data("validator") && p(this).valid()) : p(this).text(o);
				});
			},
				...
				return (
					p(".wpforms-payment-price", e).each(function () {
						var e = 0,
							t = p(this),
							r = t.attr("type");
						t.closest(".wpforms-field-payment-single").hasClass("wpforms-conditional-hide") ||
							("text" === r || "hidden" === r
								? (e = t.val())
								: ("radio" !== r && "checkbox" !== r) || !t.is(":checked")
									? t.is("select") && 0 < t.find("option:selected").length && (e = t.find("option:selected").data("amount"))
									: (e = t.data("amount")),
								l.empty(e) || ((e = l.amountSanitize(e)), (a = Number(a) + Number(e))));
					}),
					a
				);
			},
			amountSanitize: function (e) {
				...
				return (
					...
					"," === t.decimal_sep
						? ("." === t.thousands_sep && -1 !== e.indexOf(t.thousands_sep) ? (e = e.replace(new RegExp("\\" + t.thousands_sep, "g"), "")) : "" === t.thousands_sep && -1 !== e.indexOf(".") && (e = e.replace(/\./g, "")),
							(e = e.replace(t.decimal_sep, ".")))
						: "," === t.thousands_sep && -1 !== e.indexOf(t.thousands_sep) && (e = e.replace(new RegExp("\\" + t.thousands_sep, "g"), "")),
			...
			amountFormat: function (e) {
				...
				return (
					(e = String(e)),
					"," === r.decimal_sep && -1 !== e.indexOf(r.decimal_sep) && ((t = e.indexOf(r.decimal_sep)), (e = e.substr(0, t) + "." + e.substr(t + 1, e.length - 1))),
			...
			getCurrency: function () {
				...
				return (
					void 0 !== wpforms_settings.currency_code && (e.code = wpforms_settings.currency_code),
			...
			numberFormat: function (e, t, r, a) {
				...
				var o,
					...
					a = void 0 === a ? "," : a,
					r = void 0 === r ? "." : r,
					n = (t ? ((n = e), (o = t), (i = Math.pow(10, o)), "" + (Math.round(n * i) / i).toFixed(o)) : "" + Math.round(e)).split(".");
				return 3 < n[0].length && (n[0] = n[0].replace(/\B(?=(?:\d{3})+(?!\d))/g, a)), (n[1] || "").length < t && ((n[1] = n[1] || ""), (n[1] += new Array(t - n[1].length + 1).join("0"))), n.join(r);
			},
			empty: function (e) {
			...
			setUserIndentifier: function () {
				if (((!s.hasRequiredConsent && "undefined" != typeof wpforms_settings && wpforms_settings.uuid_cookie) || (s.hasRequiredConsent && s.hasRequiredConsent())) && !l.getCookie("_wpfuuid")) {
					for (var e, t = new Array(36), r = "0123456789abcdef", a = 0; a < 36; a++) t[a] = r.substr(Math.floor(16 * Math.random()), 1);
					(t[14] = "4"), (t[19] = r.substr((3 & t[19]) | 8, 1)), (t[8] = t[13] = t[18] = t[23] = "-"), (e = t.join("")), l.createCookie("_wpfuuid", e, 3999);
				}
			},
			createCookie: function (e, t, r) {
				...
				wpforms_settings.is_ssl && (i = ";secure"),
					(o = r ? ("-1" === r ? "" : ((a = new Date()).setTime(a.getTime() + 24 * r * 60 * 60 * 1e3), ";expires=" + a.toGMTString())) : ";expires=Thu, 01 Jan 1970 00:00:01 GMT"),
					(n.cookie = e + "=" + t + o + ";path=/;samesite=strict" + i);
			},
			getCookie: function (e) {
				for (var t = e + "=", r = n.cookie.split(";"), a = 0; a < r.length; a++) {
			...
			currentIpToCountry: function (r) {
				function t() {
					p.get("https://ipapi.co/jsonp", function () { }, "jsonp").always(function (e) {
						var t,
							e = e && e.country ? e.country : "";
						e || (e = -1 < (t = l.getFirstBrowserLanguage()).indexOf("-") ? t.split("-").pop() : ""), r(e);
					});
				}
			...
			// 	a && r.text(a), r.prop("disabled", !1), t.css("opacity", ""), e.find(".wpforms-submit-spinner").hide();
			// },
			// formSubmitNormal: function (e) {
			// 	var t, r;
			// 	e.length && ((r = (t = e.find(".wpforms-submit")).get(0).recaptchaID), (l.empty(r) && 0 !== r) || (t.get(0).recaptchaID = !1), e.get(0).submit());
			// },
			formHasCaptcha: function (e) {
				if (!e || !e.length) return !1;
				if ("undefined" == typeof hcaptcha && "undefined" == typeof grecaptcha) return !1;
			...
			resetFormRecaptcha: function (e) {
				var t, r;
				l.formHasCaptcha(e) &&
					((t = e.find(".wpforms-recaptcha-container").hasClass("wpforms-is-hcaptcha") ? hcaptcha : grecaptcha),
						(r = e.find(".wpforms-submit").get(0).recaptchaID),
						l.empty(r) && 0 !== r && (r = e.find(".g-recaptcha").data("recaptcha-id")),
			...
			displayFormAjaxErrors: function (e, t) {
				"string" == typeof t
					...
					: ((t = t && "errors" in t ? t.errors : null),
						l.empty(t) || (l.empty(t.general) && l.empty(t.field)) ? l.consoleLogAjaxError() : (l.empty(t.general) || l.displayFormAjaxGeneralErrors(e, t.general), l.empty(t.field) || l.displayFormAjaxFieldErrors(e, t.field)));
			},
			...
			displayFormAjaxFieldErrors: function (e, t) {
				var r;
				e && e.length && (l.empty(t) || ((r = e.data("validator")) && (r.showErrors(t), l.formHasCaptcha(e) || r.focusInvalid())));
			},
			...
			// 	return o.isDefaultPrevented() ? (l.restoreSubmitButton(a, r), p.Deferred().reject()) : p.ajax(e);
			// },
...
const progressBar = document.querySelector('.wpforms-page-indicator-page-progress')
const stepsWrapper = document.querySelector('.wpforms-page-indicator-steps-current');
let progress = 16.666,
	step = 1
...
buttons.forEach(button => {
	button.addEventListener('click', (e) => {
		const activeSection = document.querySelector('.wpforms-page._active');
		...
		if (activeSection.classList.contains('last-button')) {
			intervalFunction()
	...
	function intervalFunction() {
		...
		setTimeout(() => {
			...
			activeSection.classList.remove('_active')
			nextSection.classList.add('_active')
			if (!nextSection.classList.contains('last')) {
				intervalFunction()
			}
		}, 1500);
	}
