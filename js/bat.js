function UET(o) {
	...
	this.uetConfig.tcf = { enabled: !1, vendorId: 1126, hasLoaded: !1, timeoutId: null, gdprApplies: undefined, adStorageAllowed: undefined, measurementAllowed: undefined, personalizationAllowed: undefined };
	this.beaconParams = {};
	...
	this.knownParams = {
		...
		flight_destid: {},
		flight_originid: {},
		flight_pagetype: { type: "enum", values: ["home", "searchresults", "offerdetail", "cart", "purchase", "cancel", "other"] },
		...
		"pid.ph": { type: "pid" },
		"pid.phone_number": { type: "pid", beacon: "ph" },
	};
	this.knownEvents = {
		add_payment_info: [],
	...
	this.ambiguousValidCustomEventKeyNames = { ecomm_prodid: 1, ecomm_pagetype: 1, rep: 1, pid: 1 };
	this.validRetailPageTypeValues = { home: 1, searchresults: 1, category: 1, product: 1, cart: 1, purchase: 1, other: 1 };
	...
	this.checkuetHostdocumentload = function () {
		...
		if (
			(n.documentLoaded ||
				!document.body ||
				(document.readyState && document.readyState !== "interactive" && document.readyState !== "complete" && document.readyState !== "loaded") ||
				n.deferLoad ||
				(n.dispatchq(!0), (n.documentLoaded = !0)),
				n.documentLoaded)
		)
	...
	this.tcfCallback = function (n, t) {
		if (
			t &&
			(this.uetConfig.tcf.hasLoaded || ((this.uetConfig.tcf.hasLoaded = !0), clearTimeout(this.uetConfig.tcf.timeoutId)),
				...
				(this.uetConfig.tcf.gdprApplies = n.gdprApplies),
				n.gdprApplies !== !1)
		) {
			var i = function (t) {
				return n.purpose.consents[t] === !0 || n.purpose.legitimateInterests[t] === !0;
			};
			(n.vendor.consents[this.uetConfig.tcf.vendorId] === !0 || n.vendor.legitimateInterests[this.uetConfig.tcf.vendorId] === !0) &&
				((this.uetConfig.tcf.adStorageAllowed = i(1)), (this.uetConfig.tcf.measurementAllowed = i(7) && i(9) && i(10)), (this.uetConfig.tcf.personalizationAllowed = i(3) && i(4)));
	...
	this.isAdStorageAllowed = function () {
		return !(
			...
			(this.uetConfig.consent.enabled === !0 && this.uetConfig.consent.adStorageAllowed === !1) ||
			(this.uetConfig.tcf.enabled === !0 && this.uetConfig.tcf.hasLoaded === !0 && this.uetConfig.tcf.gdprApplies === !0 && this.uetConfig.tcf.adStorageAllowed !== !0)
		);
	};
	...
	this.loadConfig = function () {
		var u, c, e, i, s, l, f, t, a, b, v, n, y, r, p, w, h;
		...
		c = "_uetmsdns";
		o.hasOwnProperty("msDnsCookie") && o.msDnsCookie && typeof o.msDnsCookie == "string" && (c = o.msDnsCookie);
		this.uetConfig.msDns = this.getCookie(c, "", 1) === "1";
		...
		o.disableContainer === !0 && (this.uetConfig.disableContainer = !0);
		...
		this.stringExists(i) && (i.match(/^[0-9]{13}$/) || i.match(/^[0-9a-f]{8}-([0-9a-f]{4}-){3}[0-9a-f]{12}$/))
			? this.setCookie(this.uetConfig.dbgCookie, i, 0, !0, !1, "", this.cookieIdMaxLength)
		...
		l = o.Ver !== 1 ? { ti: 0, Ver: 0, tm: 1, Tag: 0, EXT_Data: 0 } : { Ver: 0, tagId: 0, Tag: 0, Sig: 0, EXT_Data: 0 };
		for (f in o) l.hasOwnProperty(f) && (this.beaconParams[f] = l[f] === 1 ? encodeURIComponent(o[f]) : o[f]);
		for (this.beaconParams.mid = this.getUuidV4(!0), t = undefined, a = 0; a < 5; a++) if (((t = "ueto_" + this.makeRandomStr(10)), !window[t])) break;
		this.stringExists(o.ti) &&
			((b = ["56004448", "5798164", "20132024", "4000835", "4074038"]),
				(v = window.navigator.userLanguage || window.navigator.language),
				this.stringExists(v) && v.indexOf("de") === 0 && b.indexOf(o.ti) !== -1 && ((this.uetConfig.deBlock = !0), (this.uetConfig.cookieAllowed = !1)));
		try {
			this.stringExists(t) && !window[t] ? (window[t] = this.uetInstance) : (t = undefined);
		} catch (n) { }
		this.stringExists(o.ti) &&
			!this.uetConfig.disableContainer &&
			((n = document.createElement("script")),
				(y = e + "//" + this.domain + "/p/action/" + o.ti + ".js"),
				this.stringExists(this.uetConfig.batDebug) && (y += "?bat_debug=" + this.uetConfig.batDebug),
				(n.src = y),
				(n.type = "text/javascript"),
				(n.async = 1),
		...
		navigator.userAgentData &&
			...
			((this.deferLoad = !0),
				...
				(p = setTimeout(function () {
					r.deferLoad = !1;
					r.fireSendBeacon("error", { msg: encodeURIComponent("Timeout requesting UA CH") });
				}, 50)),
				navigator.userAgentData.getHighEntropyValues(["platformVersion"]).then(
					...
					function (n) {
						r.deferLoad = !1;
						clearTimeout(p);
						r.fireSendBeacon("error", { msg: encodeURIComponent("Error requesting UA CH: " + n) });
					}
				));
		this.stringExists(this.uetConfig.batDebug) &&
			window.opener &&
			this.stringExists(o.ti) &&
			((w = "https://ui.ads.microsoft.com"),
				document.referrer && window.URL && ((h = new URL(document.referrer)), h.protocol === "https:" && /\.microsoft\.com$/.test(h.hostname) && (w = h.origin)),
				window.opener.postMessage({ type: "AckBatDbgMode", tagId: o.ti }, w));
	};
	...
	this.push = function () {
		...
		this.uetInstance.documentLoaded || t === "set" || t === "consent" || t === "config" ? this.uetInstance._push([t, i, r]) : this.uetInstance.eventPushQueue.push([t, i, r]);
	};
	this._push = function (n) {
		...
		if (n[1] instanceof Array)
			if (n[0] === "event") {
				...
				for (i in n[1][0])
					this.knownParams.hasOwnProperty(i) &&
						((this.pageLevelParams[i] = n[1][0][i]), i === "pid" && this.pageLoadDispatch === !0 && ((e = this.validateSubparams({ pid: n[1][0][i] }, "")), e.hasOwnProperty("pid") && this.firePidEvent(e.pid)));
			} else if (n[0] === "consent") {
				if (((this.uetConfig.consent.enabled = !0), (t = n[1][1]), (f = n[1][0]), t === null || typeof t != "object")) return;
				f === "default"
					? (t.hasOwnProperty("ad_storage") && this.uetConfig.consent.adStorageUpdated === !1 && (this.uetConfig.consent.adStorageAllowed = t.ad_storage !== "denied"),
						t.hasOwnProperty("wait_for_update") && ((r = parseInt(t.wait_for_update, 10)), !isNaN(r) && r > 0 && ((r = Math.min(r, 1e4)), (this.uetConfig.consent.waitForUpdate = r))))
					: f === "update" &&
					t.hasOwnProperty("ad_storage") &&
					((this.uetConfig.consent.adStorageAllowed = t.ad_storage !== "denied"),
						(this.uetConfig.consent.adStorageUpdated = !0),
						this.uetConfig.consent.adStorageAllowed ? this.pageLoadDispatch && this.addMsClkId(this.beaconParams) : (delete this.beaconParams.sid, delete this.beaconParams.vid, delete this.beaconParams.msclkid));
			} else if (n[0] === "config") {
	...
	this.dispatchq = function (n) {
		...
		for (
			n ||
			((this.evqDispatch = !0),
				this.uetConfig.disableVisibilityEvents === !1 && ("onpagehide" in window) && (window.addEventListener("pageshow", this.firePageShow.bind(this)), window.addEventListener("pagehide", this.firePageHide.bind(this))),
				this.uetConfig.enableAutoSpaTracking === !0 &&
				(("onpopstate" in window) && window.addEventListener("popstate", this.documentUrlChanged.bind(this, "popstate")), this.wrapHistoryMethod("pushState"), this.wrapHistoryMethod("replaceState"))),
			r = 0;
			r < this.evq.length;
			r++
		)
			if (typeof this.evq[r] == "object") {
				...
				typeof this.evq[r] == "string" || this.evq[r] instanceof String
					? (t !== undefined && i !== undefined && (n || this.push(t, i, {}), (t = i = undefined)),
						(f = this.evq[r]),
						t === undefined && (f === "set" || f === "consent" || f === "config" || f === "event") ? (t = f) : t !== undefined && i === undefined ? (i = f) : (t = i = undefined),
						r !== this.evq.length - 1 || t !== "event" || n || i === undefined || this.push(t, i, {}))
					: (t = i = undefined);
	};
	...
	this.getRandomValues =
		(window.crypto && window.crypto.getRandomValues && window.crypto.getRandomValues.bind(window.crypto)) ||
		(window.msCrypto && window.msCrypto.getRandomValues && window.msCrypto.getRandomValues.bind(window.msCrypto)) ||
		function (n) {
	...
	this.addLoadTime = function (n) {
		...
		if (
			...
			((t = window.performance.timing.domContentLoadedEventEnd),
				window.performance.timing.loadEventEnd && (t = window.performance.timing.loadEventEnd),
				t !== undefined && t !== 0 && ((e = t - window.performance.timing.navigationStart), (n.lt = e)),
	...
	this.addUrlData = function (n, t) {
		var f, e, r, u, i, o, s;
		if (((t = t === !0), (f = !1), window.window != window.top))
			try {
		...
		return (
			...
			((u = window.document.referrer),
				...
				(this.uetConfig.removeQueryFromUrls === !0 || t) && ((i = i.split("?")[0]), (u = u.split("?")[0])),
				(o = window.location.hash),
				(s = i.indexOf(o) >= 0 ? i : i + o),
				(n.p = encodeURIComponent(s)),
				(n.r = encodeURIComponent(u))),
			t && delete n.r,
			n
		);
	};
	...
	this.addPageData = function (n, t) {
		...
		return (
			...
			this.stringExists(r) && !this.stringExists(n.tl) && (n.tl = encodeURIComponent(r).replace(/%2C/gi, ",")),
			window.document.head.getElementsByTagName("meta").keywords && ((u = window.document.head.getElementsByTagName("meta").keywords.content), this.stringExists(u) && (n.kw = encodeURIComponent(u).replace(/%2C/gi, ","))),
			t ? this.stringExists(this.previousPage) && !n.hasOwnProperty("r") && (n.r = this.previousPage) : ((n = this.addUrlData(n)), (n = this.addLoadTime(n))),
	...
	this.throwError = function (n) {
		if ((this.helperError(n), this.uetConfig.errorBeaconLevel > 0)) {
			...
			var t = this.combine(this.beaconParams, { errMsg: encodeURIComponent(n) }),
	...
	this.validateValue = function (n, t, i, r) {
		...
		return (
			...
			(u = parseFloat(f)),
			(isNaN(f) || isNaN(u) || (e && u.toString().indexOf(".") !== -1)) && this.throwError(n + " should be " + (e ? "an integer" : "a number")),
			u > r ? this.throwError(n + " cannot be greater than " + r) : u < 0 ? this.throwError(n + " cannot be less than 0") : this.getDecimalPlaces(u) > i && (u = parseFloat(u.toFixed(i))),
			u
		);
	};
	...
	this.validateDataObjectNew = function (n, t) {
		...
		if (
			(this.eventBasicChecks(n, t),
				!t.hasOwnProperty("ecomm_prodid") || t.ecomm_prodid == null || (typeof t.ecomm_prodid == "string" && t.ecomm_prodid.toString() === "") || (t.ecomm_prodid = this.validateProdId(t.ecomm_prodid)),
				(u = t.event_action),
		...
		return (
			...
			!i.hasOwnProperty("pagetype") && i.hasOwnProperty("prodid") && this.throwError(this.missingPageTypeException),
			i.hasOwnProperty("pagetype") && i.pagetype === "purchase" && i.hasOwnProperty("ea") && i.ea === "purchase" && i.hasOwnProperty("ecomm_totalvalue") && !i.hasOwnProperty("gv") && (i.gv = i.ecomm_totalvalue),
			...
			((i.hasOwnProperty("hct_total_price") && i.hasOwnProperty("gc")) || this.throwError(this.missingHotelParametersException)),
			i.hasOwnProperty("hct_total_price") && i.hasOwnProperty("gv") && this.throwError(this.hotelVariableRevenueException),
			i
		);
	};
	this.validateDataObject = function (n, t) {
		...
		t.hasOwnProperty("pagetype") > 0
			? ((t.pagetype = this.validatePageType(t.pagetype, this.validRetailPageTypeValues)), t.hasOwnProperty("prodid") > 0 && (t.prodid = this.validateProdId(t.prodid)))
			: t.hasOwnProperty("prodid") > 0 && this.throwError(this.missingPageTypeException);
	};
	this.evt = function (n, t, i, r) {
		...
		if (((r = r !== !1), (i = i || {}), this.uetConfig.disableAutoPageView === !0 && this.evqDispatch === !1 && this.dispatchq(!1), typeof i == "object")) {
			if (
				(this.uetConfig.allRep === !0 ? (i.rep = "1") : i.hasOwnProperty("rep") && (i.rep === 1 || i.rep === "1" || i.rep === !0 ? (i.rep = "1") : delete i.rep),
					n === this.pageLoadEvt &&
					(this.uetConfig.gtagPid === !0 &&
						"enhanced_conversion_data" in window &&
						typeof enhanced_conversion_data == "object" &&
						(this.pageLevelParams.pid = { em: window.enhanced_conversion_data.email, ph: window.enhanced_conversion_data.phone_number }),
						r && this.pageLevelParams.hasOwnProperty("pid") && !i.hasOwnProperty("pid") && (i.pid = this.pageLevelParams.pid)),
					this.pageLevelParams.hasOwnProperty("pid") && ((this.knownEvents[t] = this.knownEvents[t] || []), this.knownEvents[t].indexOf("pid") === -1 && this.knownEvents[t].push("pid")),
					r ? this.validateDataObject(n, i) : ((i.event_action = t), n === this.customEvt && i.hasOwnProperty("gtm_tag_source") && (i = this.mapGtmParams(i)), (i = this.validateDataObjectNew(n, i))),
					n === this.customEvt)
			) {
				h = [];
				for (y in i) h.push(y);
				...
				if (((l = !r && i.hasOwnProperty("page_path")), l)) {
					if (
						((i.spa = "Y"),
							this.pageLoadDispatch === !1
								? ((u = {}), (u = this.addPageData(u, !1)), this.stringExists(u.p) && (this.previousPage = u.p), (i.r = u.r), (i.lt = u.lt), u.hasOwnProperty("pt") && (i.pt = u.pt), u.hasOwnProperty("pn") && (i.pn = u.pn))
								: (this.firePageHide(), this.midOverride || (this.beaconParams.mid = this.getUuidV4(!0))),
							i.hasOwnProperty("page_title") && ((i.tl = i.page_title), delete i.page_title),
			...
			this.pageLevelParams.hasOwnProperty("vid")
				? ((f = this.pageLevelParams.vid), typeof f == "string" && this.stringExists(f) && ((f = f.replace(/[-{}]/g, "").toLowerCase()), f.match(/^[0-9a-f]{32}$/) && ((this.beaconParams.vid = f), (this.beaconParams.vids = "3"))))
				: this.uetConfig.disableUetVid || this.addCookieId(this.beaconParams, "vid", "vids", this.uetConfig.vidCookie, this.uetConfig.disableUetVid ? 0 : this.visitorExpirationTime);
			...
			this.uetConfig.tcf.enabled === !0 &&
				((o = { st: this.uetConfig.tcf.hasLoaded === !0 ? "L" : "E" }),
					this.uetConfig.tcf.gdprApplies === !0 &&
					((o.gdpr = "Y"), this.uetConfig.tcf.adStorageAllowed === !0 && (o.as = "G"), this.uetConfig.tcf.measurementAllowed === !0 && (o.ms = "G"), this.uetConfig.tcf.personalizationAllowed === !0 && (o.pz = "G")),
					(i.tcf = encodeURIComponent(this.removeTrailingAmp(this.stringifyToRequest(o)))));
		...
		if (((s = null), i > 0 && ((s = new Date()), s.setTime(s.getTime() + i * 1e3)), (l = new Date()), l.setTime(0), u && s != null && this.setLocalStorageBackup(n, t, i), this.domainName === null || r)) {
			if (((c = this.getHostname()), c && typeof c == "string" && c !== "localhost"))
				for (h = c.split("."), o = h.pop(), h.length === 3 && Number(o) >= 0 && (h = []); h.length > 0;)
					if (
						((o = h.pop() + "." + o), this.uetConfig.cookieDomain === "" || this.uetConfig.cookieDomain.toLowerCase() === o.toLowerCase()) &&
						(r && (this._setCookie(n, "", l, o, this.uetConfig.cookieFlags), (r = !!this.getCookie(n, f, e))), !r && (this._setCookie(n, f + t, s, o, this.uetConfig.cookieFlags), this.getCookie(n, f, e)))
					) {
						this.domainName = o;
						return;
					}
	...
	this.addCookieId = function (n, t, i, r, u) {
		...
		return (this.stringExists(f) || ((h = !1), (f = this.getLocalStorageBackup(r, this.insightsCookieMaxLength))), (s = this.insightsTrimCookie(f, !0)), (f = this.insightsTrimCookie(f, !1)), u === 0)
			? (this.stringExists(f) && ((n[t] = encodeURIComponent(f)), this.stringExists(i) && (n[i] = e)), n)
			: (this.stringExists(f) && !f.match(/^[0-9a-f]{32}$/) && (f = f.replace(/-/g, "")),
				this.stringExists(f) && f.match(/^[0-9a-f]{32}$/) ? (e = "0") : ((f = this.getUuidV1(!1)), (e = "1")),
				(o = s === null ? f : f + "|" + s),
				this.setCookie(r, o, u, h, !0, "", this.insightsCookieMaxLength),
				(this.getCookie(r, "", this.insightsCookieMaxLength) === o || this.getLocalStorageBackup(r, this.insightsCookieMaxLength) === o) && ((n[t] = encodeURIComponent(f)), this.stringExists(i) && (n[i] = e)),
				n);
	};
	this.addMsClkId = function (n) {
		...
		return (
			this.stringExists(t) || (t = this.getLocalStorageBackup(this.msClkIdCookieName, this.lengthMsClkId)),
			this.stringExists(this.msClkId) ? t !== this.msClkId && (i = "1") : (this.msClkId = t),
			this.stringExists(this.msClkId)
				? (this.setCookie(this.msClkIdCookieName, this.msClkId, this.msClkIdExpirationTime, !0, !0, this.msClkIdCookieValuePrefix, this.lengthMsClkId),
					this.getCookie(this.msClkIdCookieName, this.msClkIdCookieValuePrefix, this.lengthMsClkId) !== this.msClkId && (i += "N"),
	...
	this.fireBeacon = function (n) {
		for (
			var i,
			s,
			e = this.getClUrl(this.urlPrefix),
			t = this.combine(this.beaconParams, n),
			r = this.stringifyToRequest(t),
			f = this.removeTrailingAmp(e + r),
			o = ["r", "el2", "ec2", "ea2", "page_location", "page_path", "kw", "p", "tl", "items"],
			u = 0;
			encodeURI(f).length > this.URLLENGTHLIMIT && o.length > u;
			u++
		)
			((i = o[u]), i in t) && (u == 0 ? (t[i] = t[i].split("?")[0]) : u <= 3 ? (t[i] = "") : delete t[i], (r = this.stringifyToRequest(t)), (f = this.removeTrailingAmp(e + r)));
		this.fireBeaconImg(f);
		this.snippetEventQueue.push(r);
		this.snippetEventQueue.length > 20 && this.snippetEventQueue.shift();
		try {
			typeof CustomEvent == "function" && ((s = new CustomEvent("UetEvent", { bubbles: !0, detail: { uetEvent: r } })), this.invisibleDiv.dispatchEvent(s));
		} catch (h) { }
	};
	...
	this.firePidEvent = function (n) {
		var t = this.combine(this.beaconParams, { evt: "pid", pid: n }),
			...
			if (((n.ecomm_pagetype = "purchase"), (n.ecomm_prodid = []), (n.items = []), n.hasOwnProperty("transactionProducts") && n.transactionProducts instanceof Array))
				for (r = 0; r < n.transactionProducts.length; r++)
					((t = n.transactionProducts[r]), typeof t == "object") &&
						((i = {}), t.hasOwnProperty("sku") && ((i.id = t.sku), n.ecomm_prodid.push(i.id)), t.hasOwnProperty("price") && (i.price = t.price), t.hasOwnProperty("quantity") && (i.quantity = t.quantity), n.items.push(i));
	...
	this.mapGtmEcommercePurchase = function (n) {
		...
		if (n.hasOwnProperty("ecommerce") && typeof n.ecommerce == "object") {
			if ((n.ecommerce.hasOwnProperty("ecommerce") && typeof n.ecommerce.ecommerce == "object" && (n.ecommerce = n.ecommerce.ecommerce), n.ecommerce.hasOwnProperty("purchase") && typeof n.ecommerce.purchase == "object"))
			...
			else if (n.ecommerce.hasOwnProperty("impressions") && n.ecommerce.impressions instanceof Array) (t = { products: n.ecommerce.impressions }), (n.ecomm_pagetype = "other");
			else {
				delete n.ecommerce;
				return;
			}
			if (
				(n.ecommerce.hasOwnProperty("currencyCode") && (n.currency = n.ecommerce.currencyCode),
					t.hasOwnProperty("actionField") &&
					typeof t.actionField == "object" &&
					(t.actionField.hasOwnProperty("id") && (n.transaction_id = t.actionField.id), t.actionField.hasOwnProperty("revenue") && (n.ecomm_totalvalue = t.actionField.revenue)),
					t.hasOwnProperty("products") && t.products instanceof Array)
			)
				for (n.ecomm_prodid = [], n.items = [], u = 0; u < t.products.length; u++)
					((i = t.products[u]), typeof i == "object") &&
						((r = {}), i.hasOwnProperty("id") && ((r.id = i.id), n.ecomm_prodid.push(r.id)), i.hasOwnProperty("price") && (r.price = i.price), i.hasOwnProperty("quantity") && (r.quantity = i.quantity), n.items.push(r));
			delete n.ecommerce;
		}
	};
		...
		if ((n.hasOwnProperty("ecomm_pagetype") && n.hasOwnProperty("event_value") && (n.ecomm_totalvalue = n.event_value), n.hasOwnProperty("items") && n.items instanceof Array)) {
			for (n.ecomm_prodid = [], u = [], r = 0; r < n.items.length; r++)
				((t = n.items[r]), typeof t == "object") &&
					((i = {}), (t.item_id || t.id) && ((i.id = t.item_id || t.id), n.ecomm_prodid.push(i.id)), t.hasOwnProperty("price") && (i.price = t.price), t.hasOwnProperty("quantity") && (i.quantity = t.quantity), u.push(i));
			n.items = u;
		}
	};
	...
	this.documentUrlChanged = function () {
		var n = window.location.href,
			i;
		t != n && ((t = n), (i = window.location.pathname + window.location.search + window.location.hash), this.push("event", "page_view", { page_path: i }));
	};
