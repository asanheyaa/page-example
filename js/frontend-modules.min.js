	...
	[354],
	{
		...
		1292: (e, t, n) => {
			...
			class CarouselHandlerBase extends i.default {
				getDefaultSettings() {
					return { selectors: { carousel: `.${elementorFrontend.config.swiperClass}`, slideContent: ".swiper-slide" } };
				}
				getDefaultElements() {
					const e = this.getSettings("selectors"),
				...
				getSwiperSettings() {
					...
					Object.keys(r)
						...
						.forEach((t) => {
							const n = i[t] ? i[t] : o;
							(s.breakpoints[r[t].value] = { slidesPerView: +e["slides_to_show_" + t] || n, slidesPerGroup: +e["slides_to_scroll_" + t] || 1 }),
					...
					return (
						...
						l && (s.pagination = { el: ".swiper-pagination", type: "bullets", clickable: !0 }),
		...
		6412: (e, t, n) => {
			...
			var r = n(3203),
				...
				u = r(n(1292)),
				d = r(n(7323));
			i.default.frontend = { Document: s.default, tools: { StretchElement: o.default }, handlers: { Base: l.default, StretchedElement: a.default, SwiperBase: c.default, CarouselBase: u.default, NestedTabs: d.default } };
		},
		5658: (e) => {
			"use strict";
			e.exports = elementorModules.ViewModule.extend({
				getDefaultSettings: () => ({ element: null, direction: elementorFrontend.config.is_rtl ? "right" : "left", selectors: { container: window }, considerScrollbar: !1 }),
				getDefaultElements() {
			...
			t.default = class Scroll {
				static scrollObserver(e) {
					...
					return new IntersectionObserver(function handleIntersect(n) {
						...
						e.callback({ sensitivity: e.sensitivity, isInViewport: i, scrollPercentage: o, intersectionScrollDirection: s }), (t = r);
					}, n);
				}
		...
		5955: (e, t, n) => {
			...
			var i = r(n(1192)),
				...
				l = r(n(400)),
				c = r(n(869)),
				u = (window.elementorModules = { Module: i.default, ViewModule: s.default, ArgsObject: o.default, ForceMethodImplementation: c.default, utils: { Masonry: a.default, Scroll: l.default } });
			t.default = u;
		},
		7323: (e, t, n) => {
			"use strict";
			...
			class NestedTabs extends i.default {
				...
				getDefaultSettings() {
					return {
						selectors: { tablist: '[role="tablist"]', tabTitle: ".e-n-tab-title", tabContent: ".e-con", headingContainer: ".e-n-tabs-heading", activeTabContentContainers: ".e-con.e-active", mobileTabTitle: ".e-collapse" },
				...
				getDefaultElements() {
					const e = this.getSettings("selectors");
					return { $tabTitles: this.findElement(e.tabTitle), $tabContents: this.findElement(e.tabContent), $mobileTabTitles: this.findElement(e.mobileTabTitle), $headingContainer: this.findElement(e.headingContainer) };
				}
				activateDefaultTab() {
					const e = this.getSettings(),
				...
				activateTab(e) {
					...
					i.add(s).addClass(n), i.attr({ tabindex: "0", "aria-selected": "true", "aria-expanded": "true" }), s[t.showTabFn](r, () => this.onShowTabContent(s)), s.removeAttr("hidden");
				}
				onShowTabContent(e) {
				...
				getTabEvents() {
					return { keydown: this.onTabKeyDown.bind(this), keyup: this.onTabKeyUp.bind(this), click: this.onTabClick.bind(this) };
				}
				bindEvents() {
		...
		1343: (e, t, n) => {
			...
			e.exports = function (e, t, n, a) {
				...
				if ((r(n) && s(n, c, a), a.global)) l ? (e[t] = n) : o(t, n);
					...
					l ? (e[t] = n) : i.f(e, t, { value: n, enumerable: !1, configurable: !a.nonConfigurable, writable: !a.nonWritable });
				}
				return e;
			};
		},
		...
		3712: (e, t, n) => {
			var r = n(8240),
				...
				S = (e.exports = function (e, t, n) {
					"Symbol(" === f(p(t), 0, 7) && (t = "[" + m(p(t), /^Symbol\(([^)]*)\)/, "$1") + "]"),
						n && n.getter && (t = "get " + t),
						n && n.setter && (t = "set " + t),
						(!o(e, "name") || (l && e.name !== t)) && (a ? g(e, "name", { value: t, configurable: !0 }) : (e.name = t)),
						b && n && o(n, "arity") && e.length !== n.arity && g(e, "length", { value: n.arity });
					try {
						n && o(n, "constructor") && n.constructor ? a && g(e, "prototype", { writable: !1 }) : e.prototype && (e.prototype = void 0);
					} catch (e) { }
					var r = d(e);
				...
				? s
					? function defineProperty(e, t, n) {
						if ((o(e), (t = a(t)), o(n), "function" == typeof e && "prototype" === t && "value" in n && p in n && !n[p])) {
							var r = u(e, t);
							r && r[p] && ((e[t] = n.value), (n = { configurable: h in n ? n[h] : r[h], enumerable: d in n ? n[d] : r[d], writable: !1 }));
						}
						return c(e, t, n);
					}
					: c
		...
		1557: (e, t, n) => {
			...
			e.exports = function (e, t, n, m) {
				...
				if (w) {
					...
					if (((C.prototype = T), "Error" !== S ? (a ? a(C, E) : l(C, E, { name: !0 })) : g && v in w && (c(C, w, v), c(C, w, "prepareStackTrace")), l(C, w), !f))
						try {
